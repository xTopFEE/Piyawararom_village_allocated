...
<section class="home-section">
    <div class="text">ดาวโหลดแบบฟอร์ม</div>
                        ...
                        <form action="add_file_db.php" id='import_excel_form' method="post" enctype="multipart/form-data"><br>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="name" name="name" placeholder="ชื่อแบบฟอร์ม" class='form-control col-sm-5 mx-auto' required>
                                    </div><br><br>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        <textarea type="text" id="other" name="other" placeholder="รายละเอียด" class="form-control col-sm-9 mx-auto"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
    ...
    <body style="font-family:roboto,sans-serif;">
        ...
        <div class="container">
            ...
            <div class="container shadow-lg bg-light py-3" style="border-radius: 12px;">
                ...
                <h2 class='text-center'>แบบฟอร์มที่มีให้ดาวโหลด</h2><br>
