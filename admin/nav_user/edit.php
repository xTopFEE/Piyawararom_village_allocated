		...
		<body">
			...
			<div class="container">
				<div class="container shadow-lg bg-light py-3" id='editBox' style="border-radius: 12px;">
					<h2 class='text-center'>แก้ไขข้อมูลสมาชิกในหมู่บ้าน</h2><br>
					<div id='msgEdit'></div>
					<form action="" id='editForm' method="post">
						<div class="form-group">
							<label><h4>username</h4></label><br>
							<input disabled="disabled" type="text" id="upd_username" name="upd_username" placeholder="Username" class='form-control col-sm-3 mx-auto' required>
						</div><br><br>
						<div class="form-group">
							<label><h4>รหัสผ่าน</h4></label><br>
							<input type="text" id="upd_password" name="upd_password" placeholder="รหัสผ่าน" class='form-control col-sm-3 mx-auto' required>
						</div><br><br>
						<div class="form-group">
							<label><h4>ยืนยันรหัสผ่าน</h4></label><br>
							<input type="text" id="upd_password_2" name="upd_password_2" placeholder="ยืนยันรหัสผ่าน" class='form-control col-sm-3 mx-auto' required>
						</div><br><br>
						<div class="form-group">
							<label><h4>ชื่อ-นามสกุล</h4></label><br>
							<input type="text" id="upd_fullname" name="upd_fullname" placeholder="ชื่อ-นามสกุล" class='form-control col-sm-4 mx-auto' required>
						</div><br><br>
						<center>
